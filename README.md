...
[![CI](https://img.shields.io/github/actions/workflow/status/rossigee/provider-matrix/ci.yml?branch=master)][build]
[![Version](https://img.shields.io/github/v/release/rossigee/provider-matrix)][releases]
[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)

[build]: https://github.com/rossigee/provider-matrix/actions/workflows/ci.yml
[releases]: https://github.com/rossigee/provider-matrix/releases
