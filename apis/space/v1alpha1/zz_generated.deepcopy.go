...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SpaceChild) DeepCopyInto(out *SpaceChild) {
	*out = *in
	if in.Via != nil {
	...
	if in.Suggested != nil {
		in, out := &in.Suggested, &out.Suggested
		*out = new(bool)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SpaceChild.
func (in *SpaceChild) DeepCopy() *SpaceChild {
	if in == nil {
		return nil
	}
	out := new(SpaceChild)
